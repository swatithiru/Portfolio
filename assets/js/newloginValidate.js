...
function validateUserName()
{
    ...
    if(loginName === "")
    {
        document.getElementById('user_error').innerHTML = 'user name should not be empty';
        loginName.focus();
        return false;
    ...
    {
      document.getElementById('user_error').innerHTML = 'user name should have atleast 3 to atmost 15 lowercase characters';  
      loginName.focus();
      return false;
    }
